...
class EventController extends Controller
{
    ...
    protected function deposit(Request $request, int $amount)
    {
    ...
    protected function withdraw(Request $request, int $amount)
    {
    ...
    protected function transfer(Request $request, int $amount)
    {
